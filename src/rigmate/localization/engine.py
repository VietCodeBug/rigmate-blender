"""Neutral localization and internationalization (i18n) engine for RigMate.

Canonical source language: English ('en').
Supported locales: English ('en'), Vietnamese ('vi').
Completely decoupled from Pydantic, Blender, and external server libraries.
...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "diag.weights_unweighted_title": "Unweighted Vertices Detected ({count} vertices)",
        "diag.weights_unweighted_msg": "Mesh '{name}' has {count} vertices without skinning weights.",
        "diag.weights_unweighted_action": "Assign unweighted vertices to bone vertex groups.",
        "diag.weights_exceed_title": "Vertex Weights Exceed Influence Limit ({max_weights} influences)",
        "diag.weights_exceed_msg": "Mesh '{name}' has vertices influenced by {max_weights} bones (limit is 4 for standard game engines).",
        "diag.weights_exceed_action": "Limit bone weights per vertex to 4.",
    ...
    "vi": {
        ...
        "diag.weights_unweighted_title": "Phát hiện đỉnh chưa gán trọng số ({count} đỉnh)",
        "diag.weights_unweighted_msg": "Mesh '{name}' có {count} đỉnh chưa được gán trọng số xương.",
        "diag.weights_unweighted_action": "Gán trọng số cho các đỉnh này vào vertex group phù hợp.",
        "diag.weights_exceed_title": "Trọng số đỉnh vượt quá giới hạn ({max_weights} xương)",
        "diag.weights_exceed_msg": "Mesh '{name}' có đỉnh chịu ảnh hưởng của {max_weights} xương (chuẩn engine là 4).",
        "diag.weights_exceed_action": "Giới hạn tối đa 4 trọng số xương cho mỗi đỉnh.",
